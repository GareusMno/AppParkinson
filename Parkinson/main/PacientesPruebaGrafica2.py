...
class MainWindow(QMainWindow):
    ...
    def Modificar(self):
        if (self.interfaz.modificarPaciente.text()=="Modificar paciente"):
            ...
            self.cbestadio.setEnabled(True)
            ...
            self.cbestadio.setEnabled(False)
            ...
            self.addUserDialog = addUser.ModificarPaciente(nombre,self.leNombre.text(),self.leApellido.text(),self.leSIP.text(),self.teMedicacion.toPlainText(),self.cbestadio.currentText())
    ...
    def enableButtons(self):
        if (self.interfaz.comboPacientes.currentText()=="Seleccionar paciente"):
            ...
            self.cbestadio.setCurrentIndex(0)
    ...
    def datosPaciente(self):
        ...
        self.cbestadio.setCurrentText(str(datos[4][0]))
